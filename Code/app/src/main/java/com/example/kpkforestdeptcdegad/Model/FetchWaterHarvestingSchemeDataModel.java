...
public class FetchWaterHarvestingSchemeDataModel {

    String employee_no;
    String employee_name;
    String name_of_division;
    String name_of_forest_division;
    String target_as_pc1;
    String achieved_so_far_no;
    String vdc_established;
    String progress_till_date;
    String time_date;

    public FetchWaterHarvestingSchemeDataModel(String employee_no, String employee_name, String name_of_division,
                                               String name_of_forest_division, String target_as_pc1, String achieved_so_far_no,
                                               String vdc_established, String progress_till_date, String time_date) {
        this.employee_no = employee_no;
        this.employee_name = employee_name;
        this.name_of_division = name_of_division;
        this.name_of_forest_division = name_of_forest_division;
        this.target_as_pc1 = target_as_pc1;
    ...
    public String getTarget_as_pc1() {
        return target_as_pc1;
    }

    public void setTarget_as_pc1(String target_as_pc1) {
        this.target_as_pc1 = target_as_pc1;
    }
